...
typedef enum GAP_TEMP
{
	...
	typedef enum corrected_time
		{
			corrected_time_warm_temp	= 10*3,
			corrected_time_GAP_1_temp	= 10*3,
			corrected_time_GAP_2_temp	= 10*3,
			corrected_time_GAP_3_temp	= 10*3,
			corrected_time_GAP_4_temp	= 10*12,
			corrected_time_GAP_5_temp	= 10*15,
			corrected_time_GAP_6_temp	= 10*18,
			corrected_time_GAP_7_temp	= 10*18,
			corrected_time_GAP_8_temp	= 10*18,
			corrected_time_GAP_9_temp	= 10*24,
