...
typedef enum GAP_TEMP
{
	...
	{
		corrected_value_warm_temp	= 10,
		corrected_value_GAP_1_temp	= 10,
		corrected_value_GAP_2_temp	= 10,
		corrected_value_GAP_3_temp	= 10,
		corrected_value_GAP_4_temp	= 10,
		corrected_value_GAP_5_temp	= 10,
		corrected_value_GAP_6_temp	= 10,
		corrected_value_GAP_7_temp	= 10,
		corrected_value_GAP_8_temp	= 10,
		corrected_value_GAP_9_temp	= 13,
