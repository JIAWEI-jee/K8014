...
void Controll_Heat ( u16 temp_set,u16 temp_now,u8 open_heat_temp );
void Protect ( void );
void Error ( void );
...
void Controll_Heat ( u16 temp_set,u16 temp_now,u8 open_heat_temp )
{
	if ( temp_now >= ( temp_set + 1 ) )
	{
		set_pwm ( 0 ); // 关闭加热丝
	}
	else if ( temp_now <= ( temp_set - open_heat_temp ) )
	{
		set_pwm ( 10 ); //打开加热丝
	}
}
...
void Set_Temp ( u16 temp )
{
	...
	{
		case GAP_WARM:
			Controll_Heat ( GAP_WARM_temp,temp,corrected_value_warm_temp );
			break;
		case GAP_1:
			Controll_Heat ( GAP_1_temp,temp,corrected_value_GAP_1_temp );
			break;
		case GAP_2:
			Controll_Heat ( GAP_2_temp,temp,corrected_value_GAP_2_temp );
			break;
		case GAP_3:
			Controll_Heat ( GAP_3_temp,temp,corrected_value_GAP_3_temp );
			break;
		case GAP_4:
			Controll_Heat ( GAP_4_temp,temp,corrected_value_GAP_4_temp );
			break;
		case GAP_5:
			Controll_Heat ( GAP_5_temp,temp,corrected_value_GAP_5_temp );
			break;
		case GAP_6:
			Controll_Heat ( GAP_6_temp,temp,corrected_value_GAP_6_temp );
			break;
		case GAP_7:
			Controll_Heat ( GAP_7_temp,temp,corrected_value_GAP_7_temp );
			break;
		case GAP_8:
			Controll_Heat ( GAP_8_temp,temp,corrected_value_GAP_8_temp );
			break;
		case GAP_9:
			Controll_Heat ( GAP_9_temp,temp,corrected_value_GAP_9_temp );
			break;
