...
typedef enum GAP_TEMP
{
	...
	typedef enum corrected_time
		{
			corrected_time_warm_temp	= 30*4,
			corrected_time_GAP_1_temp	= 30*3,
			corrected_time_GAP_2_temp	= 30*3,
			corrected_time_GAP_3_temp	= 30*3,
			corrected_time_GAP_4_temp	= 30*4,
			corrected_time_GAP_5_temp	= 30*5,
			corrected_time_GAP_6_temp	= 30*6,
