...
typedef enum GAP_TEMP
{
	...
	typedef enum corrected_value
	{
		...
		corrected_value_GAP_4_temp	= 8,
		corrected_value_GAP_5_temp	= 9,
		corrected_value_GAP_6_temp	= 9,
	...
	typedef enum corrected_time
		{
			...
			corrected_time_GAP_6_temp	= 60*6,
			corrected_time_GAP_7_temp	= 60*3,
			corrected_time_GAP_8_temp	= 60*3,
			corrected_time_GAP_9_temp	= 60*3,
