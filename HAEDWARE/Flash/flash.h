...
typedef enum GAP_TEMP
{
	...
	typedef enum corrected_value
	{
		...
		corrected_value_GAP_2_temp	= 5,
		corrected_value_GAP_3_temp	= 8,
		corrected_value_GAP_4_temp	= 12,
	...
	typedef enum corrected_time
		{
			...
			corrected_time_GAP_1_temp	= 60*3,
			corrected_time_GAP_2_temp	= 30*4,
			corrected_time_GAP_3_temp	= 30*6,
